...
outDir = '/Volumes/feder-vol1/home/evromero/2021_hiv-rec/results/paper/sim_fig_jc/'
...
outDir = '/net/feder/vol1/home/evromero/2021_hiv-rec/results/paper/sim_fig_jc/'
...
for name, group in grouped_par:
    ...
    axs[0].plot([time_1, time_2], [vl_1, vl_2], color = my_color, linewidth = linewidth)
    # axd['upper left'].axhline(EXAMPLE_THRESHOLD, color = "gray", linestyle = "--", linewidth = linewidth)

    axs[0].plot(ave_time, ave_vl, color = my_color2, marker = "D", markersize = 2)

...
outDir = "/Volumes/feder-vol1/home/evromero/2021_hiv-rec/results/paper/supp_participant/"
...
# outDir = "/net/feder/vol1/home/evromero/2021_hiv-rec/results/paper/supp_participant/"
...
for i in range(len(PAR_LIST)):
    ...
    ax0.fill_between(fill_x, par_bins[curr_par][1], 1.4*10**5, color = color_list[1], alpha = 0.3)
    ax0.set_ylim(4*10**2, 1.4*10**5)
    ax0.set_xlim(0, 6000)

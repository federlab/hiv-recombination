...
#not enough data to estimate p10 or p6 
stat_df = stat_df[stat_df['Participant'] != 'p10']
stat_df = stat_df[stat_df['Participant'] != 'p6']
...
ax = sns.boxplot(x = 'Participant', y = 'Estimated_Rho', data = all_par_ests,
    order = ['p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p11'])
...
plt.legend(loc='center left', bbox_to_anchor=(1.25, 0.5))
plt.tight_layout()
plt.savefig(outDir + "supp_participant.jpg")
plt.close()

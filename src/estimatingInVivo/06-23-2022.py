...
outDir = "/net/feder/vol1/home/evromero/2021_hiv-rec/results/zanini/06-23-2022/"
...
outDir = "/Volumes/feder-vol1/home/evromero/2021_hiv-rec/results/zanini/06-23-2022/"
...
for curr_thresh in GROUP_THRESHOLD_LIST:
    ...
    for name, group in stat_df.groupby('High_VL'):
        ...
        print(curr_thresh, group['Participant'].unique())

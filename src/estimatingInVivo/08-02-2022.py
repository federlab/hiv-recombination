...
dataDir = '/Volumes/feder-vol1/home/evromero/2021_hiv-rec/data/slimDatasets/2022_07_24_neut/'
outDir = '/Volumes/feder-vol1/home/evromero/2021_hiv-rec/results/slimDatasets/2022_07_24_sel/'
...
for curr_data in os.listdir(dataDir):
    ...
    timepoint_dir = dataDir + curr_data + "/numpy/"
    linkage_dir = dataDir + curr_data + "/linkage/"
    # r2_and_D = pd.read_pickle(linkage_dir + 'r2_and_D')
    loci_df = pd.read_pickle('/Volumes/feder-vol1/home/evromero/2021_hiv-rec/data/slimDatasets/2022_07_24_neut/mu1e-06_rho0.001_Ne10000_M800_rep1/analysis/FilteredLoci')
    print(loci_df['timepoint'].unique())
    quit()

    stat_df = autocorr.calculate_d_ratios(linkage_dir + 'r2_and_D', THRESHOLD)
    print(stat_df)
    quit()

    #make a dictionary for the timepoint labels
    timepoint_df = pd.read_csv(dataDir + curr_data + '/timepoint_info.tsv', sep = ' ',
...
#     r2_and_D = pd.read_pickle(dataDir + curr_data + "/linkage/r2_and_D")
#     print(stat_df)
#     print(r2_and_D)

...
outDir = "/net/feder/vol1/home/evromero/2021_hiv-rec/results/zanini/06-21-2022/"
...
outDir = "/Volumes/feder-vol1/home/evromero/2021_hiv-rec/results/zanini/06-21-2022/"
...
plt.xlabel(r'Distance X Time (bp/generation)')
plt.ylabel(r'D\' Ratio')
plt.savefig(outDir + "p1_fits_by_vl.jpg")
plt.close()
...
plt.tight_layout()
plt.savefig(outDir + "p1_estimates_by_group.jpg")
plt.close()

sns.scatterplot(x = 'Time_1', y = 'Time_2', hue = 'Ave_VL', data = stat_df)
plt.savefig(outDir + "p1_VLbyTime.jpg")
plt.close()
...
dataDir = '/Volumes/feder-vol1/home/evromero/2021_hiv-rec/data/slimDatasets/2022_08_12_MPL/'
outDir = '/Volumes/feder-vol1/home/evromero/2021_hiv-rec/results/slimDatasets/2022_08_12_MPL/'
...
fig = sns.stripplot(x = 'Sim_Rho', y = 'Est_Rho', data = estimate_df, 
    ...
    order = [r"$2\times10^{-6}$", r"$10^{-5}$", r"$2\times10^{-5}$", r"$10^{-4}$", r"$2\times10^{-4}$"])

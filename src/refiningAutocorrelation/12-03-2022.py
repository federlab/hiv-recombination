...
outDir = '/Volumes/feder-vol1/home/evromero/2021_hiv-rec/results/slimDatasets/2022_10_03_neutral/12-03-2022/'
...
for curr_rho in all_stat_dfs['Sim_Rho'].unique():
    ...
    for curr_iteration in range(0, NUM_GROUPS):
        ...
        sns.scatterplot(x = res_bins[:-1], y = residuals, color = 'red')
        sns.lineplot(x = x_vals, y = fit_vals, color = 'gray')

...
outDir = '/Volumes/feder-vol1/home/evromero/2021_hiv-rec/results/slimDatasets/2022_07_24_neut/'
...
for curr_data in os.listdir(dataDir):
    ...
    seg_hist_data.append(len(all_seg_loc))
    ...
    coeffs, fit_dat = optimize.curve_fit(plne.neher_leitner, 
        stat_df['Dist_X_Time'], stat_df['d_ratio'],
    ...
    estimate_df.append([coeffs[0], coeffs[1], coeffs[2], 
        coeffs[1] * coeffs[2], curr_data, sim_rho, 
        curr_data])  

...
#This script is going to be used to count the number of D' ratios we have
#collected from the simulation runs so far. 
...
print(np.sum(num_seg_pairs['num_seg_pairs']))
print(num_seg_pairs['rep'].unique())

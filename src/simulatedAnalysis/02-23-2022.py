...
#         print(all_frequencies, file = sys.stderr)
#         #perform our fitting
#         try:
...
sns.pointplot(x = 'Sim_int_rho', y = 'Sim_int_rho', data = not_zeros, capsize = 0.7, ci = 0, scale = 0, color = 'black')

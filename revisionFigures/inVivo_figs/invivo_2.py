...
outDir = "/Volumes/feder-vol1/home/evromero/2021_hiv-rec/results/revision/inVivo_figs/inv_2/"
...
# outDir = "/net/feder/vol1/home/evromero/2021_hiv-rec/results/revision/inVivo_figs/inv_2/"
...
ax0.set_ylim(np.min(viralLoadData['Viral load [virions/ml]']),  10**6)
ax0.set_xlim(0, 3500)
ax0.set_yscale('log')
ax0.set_xlabel("Time (days since EDI)")
ax0.set_ylabel("Viral Load (copies/mL)")
